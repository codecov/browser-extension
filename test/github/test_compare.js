...
describe('github compare', function(){
  ...
  it('should add coverage button', function(){
    ...
    var text = ["Not covered", "Not covered", "Coverage 89.17% (Diff 68.42%)", "Coverage 60.00% (Diff 60.00%)", "Coverage 88.89% (Diff 88.24%)",
                "Coverage 77.78% (Diff 77.78%)", "Not covered", "Not covered"];
