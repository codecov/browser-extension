...
window.BitbucketServer = (function(superClass) {
  ...
  BitbucketServer.prototype.bind_id = '';
  ...
  BitbucketServer.prototype.parse_href = function() {
    ...
    if (this.page === 'pull-requests' && this.href.length >= 9) {
      this.sub_page = this.href[9];
    }
    switch (this.page) {
      case 'pull-requests':
        if (this.href.length < 9) {
          return this.register_bind_id('.pull-request-list');
        } else {
          this.register_bind_id('.tabs-menu');
          if (((ref1 = this.sub_page) === 'diff' || ref1 === 'commits') && this.href[this.href.length] !== 'commits') {
            return this.register_bind_id('.file-tree-wrapper');
          }
        }
        break;
      case 'browse':
        if ($('#browse-table').length !== 0) {
          return this.register_bind_id('.filebrowser-content');
        } else {
          return this.register_bind_id('.content-view');
        }
        break;
      case 'commits':
        if (this.href.length > 8 && this.href[8].indexOf('#') === -1) {
          return this.register_bind_id('.commit-files');
        } else {
          return this.register_bind_id('#commits-table');
        }
    }
  };
