...
window.Github = (function(superClass) {
  ...
  Github.prototype.overlay = function(res) {
    ...
    if (this.page === 'tree') {
      ...
      $('.new-commit-tease .right').append("<a href=\"" + this.settings.urls[this.urlid] + "/github/" + this.slug + "?ref=" + this.ref + "\" class=\"sha-block codecov codecov-removable tooltipped tooltipped-n\" aria-label=\"Overall coverage\">" + (res['report']['coverage'].toFixed(2)) + "%</a>");
      ...
      $('#toc li').each(function() {
        ...
        if (!(coverage != null ? coverage.ignored : void 0)) {
          ...
          if (cov >= 0) {
            return $('.new-commit-tease .right', this).prepend("<span class=\"codecov codecov-removable\">" + (Math.round(cov)) + "%</span>");
          }
        }
      });
      self = this;
      return $('.repository-content .file').each(function() {
        var _td, button, diff, file, fp, hits, ref1, ref2, ref3, total;
        file = $(this);
        ...
        if (fp) {
          ...
          if (!(coverage != null ? coverage.ignored : void 0)) {
            ...
            if (coverage) {
              ...
              if ((ref2 = self.page) === 'compare' || ref2 === 'pull') {
