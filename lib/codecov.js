...
window.Github = (function(superClass) {
  ...
  Github.prototype.overlay = function(res) {
    ...
    if (this.page === 'tree') {
      ...
      $('.commit-meta').remove('.codecov').prepend("<a href=\"" + this.settings.urls[this.urlid] + "/github/" + this.slug + "?ref=" + this.ref + "\" class=\"sha-block codecov tooltipped tooltipped-n\" aria-label=\"Overall coverage\">" + (res['report']['coverage'].toFixed(2)) + "%</a>");
      return $('.file-wrap tr:not(.warning):not(.up-tree)').each(function() {
        ...
        if (filepath) {
          ...
          if (!(coverage != null ? coverage.ignored : void 0)) {
            if (coverage >= 0) {
              return $('td:last', this).remove('.codecov').append("<span class=\"sha codecov tooltipped tooltipped-n\" aria-label=\"Coverage\">" + (coverage.toFixed(2)) + "%</span>");
            }
          }
        }
      });
...
window.Bitbucket = (function(superClass) {
  ...
  Bitbucket.prototype.overlay = function(res) {
    ...
    $('#source-list tr').each(function() {
      ...
      if (!(coverage != null ? coverage.ignored : void 0)) {
        cov = coverage != null ? coverage.coverage : void 0;
        return $('td.size', this).after('<td title="Coverage" class="codecov">' + (cov >= 0 ? (cov.toFixed(2)) + "%" : '') + "</td>");
      }
    });
