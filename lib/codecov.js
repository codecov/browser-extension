...
window.Github = (function(superClass) {
  ...
  Github.prototype.get_ref = function(href) {
    var ref, ref1, split;
    this.service = window.location.hostname === 'github.com' ? 'gh' : 'gle';
    this.file = null;
  ...
  Github.prototype.overlay = function(res) {
    var _td, compare, coverage, plus, ref, ref1, replacement, self, split_view, total_hits, total_lines;
    this.log('::overlay');
    self = this;
...
window.Bitbucket = (function(superClass) {
  ...
  Bitbucket.prototype.get_ref = function(href) {
    var ref;
    this.log('::get_ref');
    this.service = window.location.hostname === 'bitbucket.org' ? 'bb' : 'bbs';
    if (this.page === 'src') {
