...
window.Github = (function(superClass) {
  ...
  Github.prototype.overlay = function(res) {
    var _td, base_url, c, commits, compare, i, len, plus, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, report, self, split_view, total, total_hits, total_lines;
    this.log('::overlay');
    self = this;
    ...
    if (this.page === 'commits') {
      ...
      if (this.page === 'tree') {
        ...
        if ((ref4 = this.page) === 'commit' || ref4 === 'compare' || ref4 === 'pull') {
          if (res.base != null) {
            if (report.totals.c != null) {
              ...
              if ((ref5 = res.base) != null ? (ref6 = ref5.report) != null ? (ref7 = ref6.totals) != null ? ref7.c : void 0 : void 0 : void 0) {
        ...
        $('.repository-content .file').each(function() {
          var button, diff, file, file_data, file_lines, fp, hits, lines, ref10, ref11, ref12, ref8, ref9;
          file = $(this);
          ...
          if (fp) {
            ...
            if ((file_data != null) && (file_data != null ? file_data.ignored : void 0) !== true) {
              total = self.format(((ref8 = file_data.t) != null ? ref8.c : void 0) != null ? file_data.t.c : file_data.coverage);
              button = file.find('.btn.codecov').attr('aria-label', 'Toggle Codecov (c), alt+click to open in Codecov').attr('data-codecov-url', (self.settings.urls[self.urlid] + "/" + self.service + "/" + self.slug + "/") + (((ref10 = file_data.t) != null ? ref10.c : void 0) != null ? "src/" + self.ref + "/" + fp : fp + "?ref=" + self.ref)).text(total + "%").removeClass('disabled').unbind().click((ref9 = self.page) === 'blob' || ref9 === 'blame' ? self.toggle_coverage : self.toggle_diff);
              hits = 0;
              lines = 0;
              ...
              file.find('tr').each(function() {
                var cov, ref11, td;
                td = $(_td, this);
                cov = self.color(file_lines[td.attr('data-line-number') || ((ref11 = td.attr('id')) != null ? ref11.slice(1) : void 0)]);
                if (cov) {
                  if (split_view) {
              ...
              total_hits += hits;
              total_lines += lines;
              if ((ref11 = self.page) === 'commit' || ref11 === 'compare' || ref11 === 'pull') {
              ...
              if (self.settings.overlay && ((ref12 = self.page) === 'blob' || ref12 === 'blame')) {
        ...
        if ((ref8 = self.page) === 'commit' || ref8 === 'compare' || ref8 === 'pull') {
